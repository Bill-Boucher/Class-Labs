...
public class Week4Labs {
	...
	public static void main(String[] args) {
		...
		//A String is can never be changed. This can cause an increase in memory usage. A StringBuilder can be changed multiple times.
		...
		System.out.println("------------");
		List<String> searchResults=search(strings, "B");
		...
		List<List<Integer>> sortedNumbers = sortDivisbleNumbers (numbers);
	...
	public static List<List<Integer>> sortDivisbleNumbers(List<Integer> list){
